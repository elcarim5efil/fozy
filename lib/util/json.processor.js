...
var _require_from_new = require('./require_from_new');
...
var JSONProcessor = function () {
    function JSONProcessor(option) {
        ...
        try {
            this.processor = _fs2.default.existsSync(option.module) ? (0, _require_from_new2.default)(option.module) : undefined;
        } catch (err) {
