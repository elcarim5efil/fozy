...
var _streamInjecter = require('stream-injecter');

var _streamInjecter2 = _interopRequireDefault(_streamInjecter);
...
module.exports = function (opts) {
    ...
    return function (ctx, next) {
        return next().then(function () {
            ...
            if (!snippet || !(ctx.response.type && ~ctx.response.type.indexOf("text/html"))) {
                return;
            }
            ...
            if (ctx.body && typeof ctx.body.pipe === 'function') {
                var injecter = new _streamInjecter2.default({
                    matchRegExp: /(<\/body>)/,
                    inject: snippet,
                    replace: snippet + '$1',
