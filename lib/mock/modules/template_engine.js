...
var tplEngine = function tplEngine(option) {
    ...
    return function () {
        var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(ctx, next) {
            var tpl, pageFile, p, pjs, data, gData, json, process, body, query, html;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 9:
                            ...
                            pjs = path.join(__root, config.template.mock || '', (pageFile || ctx.url) + '.js');
                            ...
                            _context.prev = 13;
                            _context.next = 16;
                            return fs.readFileAsync(p, 'utf-8');
                        ...
                        case 21:
                            ...
                            _context.prev = 22;
                            _context.next = 25;
                            return fs.readFileAsync(gp, 'utf-8');
            ...
            }, _callee, undefined, [[13, 19], [22, 28], [34, 40], [45, 52]]);
        }));
